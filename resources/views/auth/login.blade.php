                    ...
                    <div class="row">
                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-1 text-sm mx-auto">
                                        Olvido su contraseña? Reestablecer contraseña
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://media.istockphoto.com/id/494833184/photo/shiny-gold-and-silver-jewelery.jpg?s=612x612&w=0&k=20&c=IyxoyEJuKNpTkiuoFMsw4wJT9fI-r0MkLJ0JxOrcg44=');
              background-size: cover;">
                                <span class="mask bg-gradient-info opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">Bienvenido al sistema de empeños Joyerinueva</h4>
