...
window.warningAlert = function (msg) {
  var title = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  Swal.fire({
    title: title,
    text: msg,
...
window.confirmDialog = function (title, msg, icon, success) {
  var cancel = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';
  Swal.fire({
    title: title,
    text: msg,
    icon: icon,
    ...
    if (result.isConfirmed) {
      ...
      if (cancel !== '') window.warningToast(cancel);
    }
  });
};
...
window.confirmToast = function (msg) {
...
/*!************************************!*\
  ...
  \************************************/
__webpack_require__(/*! ./alerts.js */ "./resources/js/custom/alerts.js");
})();
